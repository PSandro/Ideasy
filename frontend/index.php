    ...
    <nav class="navbar navbar-toggleable-md fixed-top navbar-transparent" color-on-scroll="300">
        <div class="container">
            <div class="navbar-translate">
                ...
                <a class="navbar-brand" href="index.html"><img id="logo" src="ideasy-logo-white.png" width="200" height="40" alt="Ideasy"></a>
            </div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="info">
							...
							<div class="description">
								<h4 class="info-title">Altersüberprüfung</h4><br/>
					...
					<div class="col-md-4">
						<div class="info">
							...
							<div class="description">
								<h4 class="info-title">Adressüberprüfung</h4><br/>
					...
					<div class="col-md-4">
						<div class="info">
							...
							<div class="description">
								<h4 class="info-title">Identitätsüberprüfung</h4><br/>
          ...
          <div class="row">
              ...
              <div class="section landing-section">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <h2 class="text-center">Hast Du noch Fragen?</h2><br/><br/>
